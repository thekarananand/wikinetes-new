...
sampledata = [
    ...
    },
    {
        ...
        <p>The quest for "pure" water, then, involves removing these unwanted elements to a level deemed safe for human consumption. This process can vary depending on the source and intended use:</p>
x = mycol.insert_many(mylist)
        <ul>
            <li><b>Public water systems</b> treat water using a multi-step approach, typically employing filtration, coagulation, disinfection, and sometimes additional processes like reverse osmosis. This ensures its compliance with national or regional drinking water quality standards.</li>
            <li><b>Bottled water</b> undergoes filtration and purification processes, which can vary across brands and sources. While often marketed as "pure," it's essential to scrutinize labels and understand the treatment methods used.</li>
        ...
        <ul>
            ...
            <li><b>Read labels:</b> Scrutinize bottled water labels to understand the source, purification methods, and mineral content.</li>
            <li><b>Consider home filtration:</b> If your water quality raises concerns, explore reputable home filtration systems tailored to your needs.</li>
            <li><b>Practice good hygiene:</b> Wash your hands thoroughly before handling drinking water, and regularly clean containers and storage units.</li>
        </ul>
...
_id = col_articles.insert_many(sampledata)
